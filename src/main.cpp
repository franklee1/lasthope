...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Big Box Coin 2018 really grat bbb";
        CTransaction txNew;
        txNew.nTime = 1525764970;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1525764970;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 461821 : 461821;
        ...
        assert(block.hashMerkleRoot == uint256("0x5ddeb04b9796a40b5c08a23857bf33cdae2880e1fede2ea82a053406a2709a8b"));
